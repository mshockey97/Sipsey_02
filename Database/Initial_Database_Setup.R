...
db <- create_sqlite(dir = working_dir, filename = "SWI", connect = T)

#2.2 Insert equipment iunformation----------------------------------------------
#Load existing equipment table
equipment<-read.csv(paste0(working_dir,"/database_information/equipment.csv"))
...
sites<-read.csv(paste0(working_dir,"/database_information/sites.csv"))
